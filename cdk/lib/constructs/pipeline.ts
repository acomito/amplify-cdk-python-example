            ...
            phases: {
              ...
              build: {
                commands: [
                  ...
                  `    aws apprunner update-service --service-arn ${props.appRunner.service.serviceArn} --source-configuration "ImageRepository={ImageIdentifier=\${IMAGE_URI},ImageRepositoryType=ECR,ImageConfiguration={Port=${props.config.appRunner.port}}}" && break`,
                  "  else",
